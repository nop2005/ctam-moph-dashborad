...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!province_id) {
      return new Response(
        JSON.stringify({ success: false, error: "province_id is required" }),
    ...
    for (const hospital of hospitals) {
      ...
      // Update profile with hospital_id, province_id, role = 'ceo', is_active = false
