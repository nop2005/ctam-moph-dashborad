-- Create function to get public report summary data
-- This returns aggregated data at region and province level only (no hospital details)

CREATE OR REPLACE FUNCTION public.get_public_report_summary(p_fiscal_year integer DEFAULT NULL)
RETURNS JSON
LANGUAGE plpgsql
STABLE
SECURITY DEFINER
...
GRANT EXECUTE ON FUNCTION public.get_public_report_summary(integer) TO anon;
GRANT EXECUTE ON FUNCTION public.get_public_report_summary(integer) TO authenticated;