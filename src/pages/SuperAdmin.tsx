...
export default function SuperAdmin() {
  ...
  return <DashboardLayout>
      ...
      {(cardFilter === 'all' || cardFilter === 'pending') && <Card>
            <CardHeader>
            ...
            <CardContent>
              {isLoading ? <div className="text-center py-8">
                ...
                </div> : filteredPendingProfiles.length === 0 ? <div className="text-center py-12 text-muted-foreground">
                  <UserCheck className="h-12 w-12 mx-auto mb-4 opacity-50" />
                  <p>ไม่มีผู้ใช้รอการอนุมัติ</p>
                </div> : <div className="space-y-4">
                  {filteredPendingProfiles.map(p => <Card key={p.id} className="border-warning/30">
                      <CardContent className="p-4">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          <div className="space-y-1">
                            <div className="font-medium">{p.full_name || 'ไม่ระบุชื่อ'}</div>
                            <div className="text-sm text-muted-foreground">{p.email}</div>
                            {p.phone && <div className="flex items-center gap-1 text-sm text-muted-foreground">
                ...
                <Table>
                  ...
                  <TableBody>
                    {isLoading ? <TableRow>
                      ...
                      </TableRow> : filteredActiveProfiles.length === 0 ? <TableRow>
                        <TableCell colSpan={6} className="text-center py-8 text-muted-foreground">
                          ไม่พบข้อมูลผู้ใช้
                        </TableCell>
                      </TableRow> : filteredActiveProfiles.map(p => <TableRow key={p.id}>
